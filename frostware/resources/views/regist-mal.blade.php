    ...
    <div class="register-container">
        ...
        <form class="form-box" action="{{ route('register.post') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input required name="nomorTelepon" value="{{ old('nomorTelepon') }}" class="form-input" type="tel"
                    pattern="08[0-9]{9,13}" placeholder="087654321000">
            </div>
            <div class="form-group">
            ...
            @if(session('statusMessage'))
                <div class="statusregist" data-status="{{ session('status', 'gagal') }}">
